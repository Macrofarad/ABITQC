...
%\usepackage{siunitx} % not in use
% circuitikz install instructions https://github.com/circuitikz/circuitikz/wiki/Installation
\usepackage[american]{circuitikzgit} % To draw digital logic circuits % http://texdoc.net/texmf-dist/doc/latex/circuitikz/circuitikzmanual.pdf
...
A more advanced concept that is still core to quantum computing is the idea of reversible logic gates.
