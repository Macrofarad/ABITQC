...
\begin{figure}
\begin{comment}%keeping for reference
...
\[\Qcircuit @C=1em @R=.7em {
	& \lstick{\ket{\psi}} & \targ & \targ & \qw & \targ & \qw & \meter \\
	& \lstick{\ket{\psi}} & \ctrl{-1} & \qw &\qw & \qw & \qw & \meter \\
	& \lstick{\ket{\psi}} & \qw & \ctrl{-2} & \qw & \qw & \qw & \meter \\
	& \lstick{\ket{\psi}} & \qw & \qw & \qw & \ctrl{-3} & \qw & \meter\\
}\]
%\end{verbatim}}
%&\lstick{\ket{\psi}}
