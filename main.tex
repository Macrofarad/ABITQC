...
\end{table}
\subsection{Vectors}
\label{THISNEEDSTOGETDONE} %or commented out until it is ready
...
Back in the section involving balanced ternary it was mentioned that the concept of quantities innately having a sign polarity would be relevant later, this section is that aforementioned later.
