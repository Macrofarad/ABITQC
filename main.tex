...
\begin{document}
	...
	\textcolor{mygray}{
			...
			\caption{Photograph of Bristlecone courtesy of Google}\label{titleImage} %https://ai.googleblog.com/search/label/Quantum%20Computing
			\end{figure}}
	\begin{abstract}
		
		\begin{comment} %pre BY changes
